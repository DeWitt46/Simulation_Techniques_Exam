...
int main() { // Begin main program without card file.
	...
	TFile* outFile = new TFile("pp13TeV.root", "RECREATE");
	
	// Book histogram.
	TH1F *mult = new TH1F("mult","charged multiplicity", 400, -0.5, 200.5);
	...
	Pythia reader;
	reader.readFile("exam_settings.cmnd", 1);	
