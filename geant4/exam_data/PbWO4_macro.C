...

{
	...
	TFile* inFile1 = new TFile("PbWO4_lowE_lowD.root", "READ");    
	...
	TFile* inFile2 = new TFile("PbWO4_lowE_highD.root", "READ");
	...
	TFile* inFile3 = new TFile("PbWO4_lowE_rightD.root", "READ");
	...
	TFile* inFile4 = new TFile("PbWO4_highE_rightD.root", "READ");
    ...
    c1->cd(1);
    // Settings
    hist1->SetTitle("Edep PbWO4 calorimeter");    
...
//	legend1->SetHeader("The Legend Title","C"); // option "C" allows to center the header
    ...
    c1->cd(2);    
    // Settings
    hist2->SetTitle("Edep PbWO4 calorimeter");    
	...
	//Draw Legend
	auto legend2 = new TLegend(0.1, 0.7, 0.35, 0.9); //x1,y1,x2,y2
//	legend2->SetHeader("The Legend Title","C"); // option "C" allows to center the header
    ...
    c2->cd(1);
    // Settings
    hist3->SetTitle("Edep PbWO4 calorimeter");    
...
//	legend3->SetHeader("The Legend Title","C"); // option "C" allows to center the header
    ...
    c2->cd(2);    
    // Settings
    hist4->SetTitle("Track length in 10 cm thick PbWO4 calorimeter");    
    hist4->GetXaxis()->SetRangeUser(30.5, 51);
...
//	legend4->SetHeader("The Legend Title","C"); // option "C" allows to center the header
    ...
    hist5->SetTitle("Edep in 4.5 cm thick PbWO4 calorimeter");    
    hist5->GetXaxis()->SetRangeUser(-0.5, 151);
...
//	legend5->SetHeader("The Legend Title","C"); // option "C" allows to center the header
	...
	legend5->AddEntry(hist6, "150 MeV EM shower","f");	
	legend5->Draw();
